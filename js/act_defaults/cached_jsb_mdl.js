...
var z="* Returns SqlFilter and SqlColumns as variable in HTML\xFE";
 ...
 z+="        End If\xFE";
 z+="        \xFE";
 z+="        if db then attachdb db else debug ;* ??\xFE";
 z+="        \xFE";
...
var z="Function formViewNColumns(ByVal ProjectName As String, ByVal objectModel As JSON, ByVal doKOBinding As String, byval useRow As JSON, ByVal viewName As String)\xFE";
...
var z="Program ReGen\xFE";
 ...
 z+="    Help[-1] = Help<-1> = \"   option N)o inline modeler generation\"\xFE";
 z+="    \xFE";
...
var z="* %options aspxC-\xFE";
 ...
 z+="        \xFE";
 z+="        // for testing\xFE";
 z+="        if @Domain = \"idfg.idaho.gov\" Or @Domain = \"localhost\" Then\xFE";
...
var z="\xFE";
 ...
 z+="\xFE";
 z+="    // Do we have a lat and a lng column?\xFE";
 z+="    TableColumns = @getTableColumnDefs(tableName, false /* Suppress Msgs */, True /* Refresh */)\xFE";
 z+="    \xFE";
