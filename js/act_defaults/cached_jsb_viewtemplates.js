anonymousFunc = function () {
    ...
    z += "\xFE";
    z += "{name:'gridType', index:28, label:'Grid Type', width:12, control:'dropDownBox', canedit:true, required: false, notblank: true, defaultvalue:0, reflist: \"jqGrid,0;devXServer,1;devxClient,2\" },\xFE";
    ...
    z += "{name:'hideExportBtns', index:28, label:'Hide Export Btns', width:12, control:'checkbox', canedit:true, required: false, notblank: true, defaultvalue:0, reflist: \"false,0;true,1\" },\xFE";
    z += "\xFE";
    ...
    z += "   **\xFE";
    z += "   if viewModel.gridType = 0 Then useJQGrid = 1\xFE";
    z += "   if viewModel.gridType = 1 Then devXGrid_Server = 1\xFE";
    z += "   if viewModel.gridType = 2 Then jsDexXGrid = 1\xFE";
    z += "   if !useJQGrid Then viewModel.useajax = false\xFE";
    z += "   \xFE";
    z += "   niceViewName = @NiceName(@DropIfRight(viewName, \".view\", true)) \xFE";
    z += "   nicEditID = \"ne_\":niceViewName\xFE";
    z += "   mayCRUD = viewModel.allowNewRecord Or viewModel.allowupdates Or viewModel.allowdeletes Or viewModel.newRecord\xFE";
    ...
    z += "Subroutine view_<%=niceViewName%>_Setup(ByRef viewVars As JSON)\xFE";
    z += "    \xFE";
    z += "    if !viewVars.tmpPrefix Then viewVars.tmpPrefix = @UserName:\"_<%=pageName%>_<%=viewName%>_\"\xFE";
    z += "    if !viewVars.userSettings Then viewVars.userSettings = {}\xFE";
    z += "    Dim Settings As JSON = viewVars.userSettings\xFE";
    z += "    \xFE";
    z += "    <% if viewModel.attachdb then %>\xFE";
    z += "        Settings.databaseName = \"<%=viewModel.attachdb%>\"\xFE";
    z += "        AttachDB Settings.databaseName else Stop @Errors\xFE";
    z += "    <% end if %>\xFE";
    z += "    \xFE";
    z += "    <% If devXGrid_Server then%>\xFE";
    z += "        Dim devXGridLayout As String = Settings.devXGridLayout\xFE";
    z += "        if !devXGridLayout Then\xFE";
    z += "            Read devXGridLayout From fHandle('tmp'), viewVars.tmpPrefix:\"layout\" Else devXGridLayout = \"\"\xFE";
    z += "            Settings.devXGridLayout = devXGridLayout\xFE";
    z += "        End If\xFE";
    z += "        \xFE";
    z += "        if !Settings.devXGridFilter Then\xFE";
    z += "            Dim devXGridFilter As String = \"\"\xFE";
    z += "            Read devXGridFilter From fHandle('tmp'), viewVars.tmpPrefix:\"_filter\" Else devXGridFilter = \"\"\xFE";
    z += "            Settings.devXGridFilter = devXGridFilter\xFE";
    z += "        End If\xFE";
    z += "    <% Else %>\xFE";
    z += "        Dim devXGridLayout As JSON = Settings.devXGridLayout\xFE";
    z += "        if !devXGridLayout Then\xFE";
    z += "            ReadJSON devXGridLayout From fHandle('tmp'), viewVars.tmpPrefix:\"layout\" Else devXGridLayout = {}\xFE";
    z += "            Settings.devXGridLayout = devXGridLayout\xFE";
    z += "        End If\xFE";
    z += "        \xFE";
    z += "        if !Settings.devXGridFilter Then\xFE";
    z += "            Dim devXGridFilter As JSON = {}\xFE";
    z += "            ReadJSON devXGridFilter From fHandle('tmp'), viewVars.tmpPrefix:\"_filter\" Else devXGridFilter = {}\xFE";
    z += "            Settings.devXGridFilter = devXGridFilter\xFE";
    z += "        End If\xFE";
    z += "    <% End If %>\xFE";
    z += "\xFE";
    z += "    <%if latColumnName And lngColumnName Then %>\xFE";
    z += "        Settings.showKMLExport = True\xFE";
    ...
    z += "    Settings.primaryKeyField = \"<%=@jsb_mdl.pkColumnID(viewModel, ProjectName, viewName)%>\"\xFE";
    z += "    \xFE";
    ...
    z += "\xFE";
    z += "Subroutine view_<%=niceViewName%>_Unload(ByRef viewVars As JSON)\xFE";
    z += "    <%if jsDexXGrid then%>\xFE";
    z += "        Dim Cmd As String = @formVar('Btn'):@formVar('BtnReset')\xFE";
    z += "        Dim Settings As Json = viewVars.userSettings\xFE";
    z += "    \xFE";
    z += "        // Record current settings\xFE";
    z += "        Settings.devXGridLayout = CJSON(@formVar('devXGrid_devXGridLayout'))\xFE";
    z += "        Settings.devXGridFilter = CJSON(@formVar('devXGrid_devXGridFilter'))\xFE";
    z += "        \xFE";
    z += "        // Record current user display settings for devXgrid\xFE";
    z += "        viewVars.lastCmd = Cmd\xFE";
    z += "\xFE";
    z += "        WriteJSON Settings.devXGridLayout On fHandle('tmp'), viewVars.tmpPrefix:\"_layout\" Else Null\xFE";
    z += "        WriteJSON Settings.devXGridFilter On fHandle('tmp'), viewVars.tmpPrefix:\"_filter\" Else Null\xFE";
    z += "    <%Elseif devXGrid_Server then%>\xFE";
    z += "        Dim Cmd As String = @formVar('Btn'):@formVar('BtnReset')\xFE";
    z += "        Dim Settings As Json = viewVars.userSettings\xFE";
    z += "    \xFE";
    z += "        // Record current settings\xFE";
    z += "        devXGrid = System(29).getControl(\"<%=niceViewName%>\")\xFE";
    z += "        Settings.devXGridLayout = devXGrid.SaveClientLayout()  \xFE";
    z += "        Settings.devXGridFilter = devXGrid.FilterExpression \xFE";
    z += "        \xFE";
    z += "        // Record current user display settings for devXgrid\xFE";
    z += "        viewVars.lastCmd = Cmd\xFE";
    z += "\xFE";
    z += "        Write Settings.devXGridLayout On fHandle('tmp'), viewVars.tmpPrefix:\"_layout\" Else Null\xFE";
    z += "        Write Settings.devXGridFilter On fHandle('tmp'), viewVars.tmpPrefix:\"_filter\" Else Null\xFE";
    z += "    <%Else%>\xFE";
    ...
    z += "<%$include _checkCommands%>\xFE";
    z += "\xFE";
    z += "Function gridFetch_<%=niceViewName%>(ByVal formVars As JSON, ByRef rtnErrors As String) As Object\xFE";
    ...
    z += "    <%End If%>\xFE";
    z += "    <%if devXGrid_Server then%>\xFE";
    z += "         Return selectHandle  // Return SelectHandle as datasource for devX components\xFE";
    z += "    <%else%>\xFE";
    ...
    z += "    Dim preScripts As Array = []\xFE";
    z += "    Dim postScripts As Array = []\xFE";
    z += "    Dim Settings As JSON = viewVars.userSettings\xFE";
    z += "    \xFE";
    ...
    z += "    <% Else %>\xFE";
    z += "        Dim DataSource As Object = gridFetch_<%=niceViewName%>(@FormVars, rtnErrors)\xFE";
    z += "        If rtnErrors Then\xFE";
    z += "            Return rtnErrors:crlf():@Button('backErr', \"Back\", { onclick: \"window.history.go(-2);\" } )\xFE";
    z += "        End If\xFE";
    z += "    <%End If%>\xFE";
    z += "\xFE";
    z += "    Dim moreBtns As Array = []\xFE";
    ...
    z += "    Settings.additionalButtons = moreBtns\xFE";
    z += "    \xFE";
    z += "    <%if devXGrid_Server then %>\xFE";
    ...
    z += "        Html = setup_devXGrid(<%=niceViewName%>, DataSource, Settings)\xFE";
    ...
    z += "\xFE";
    z += "        if Trim(Settings.devXGridLayout) = \"\" Then\xFE";
    ...
    z += "                Settings.devXGridLayout = \"\"\xFE";
    z += "            Else\xFE";
    z += "                // Record new settings\xFE";
    z += "                Settings.devXGridLayout = devXGrid.SaveClientLayout()  \xFE";
    z += "                Settings.devXFilter = devXGrid.FilterExpression \xFE";
    z += "            End If\xFE";
    z += "            \xFE";
    z += "            Write Settings.devXGridLayout On fHandle('tmp'), viewVars.tmpPrefix:\"_layout\" Else Null\xFE";
    z += "            Write Settings.devXGridFilter On fHandle('tmp'), viewVars.tmpPrefix:\"_filter\" Else Null\xFE";
    ...
    z += "\xFE";
    z += "\xFE";
    z += "    <%elseIf jsDexXGrid Then%>   \xFE";
    z += "\xFE";
    z += "        if isSelectList(DataSource) Then DataSource = GetList(DataSource)\xFE";
    z += "\xFE";
    z += "        // =============   ============= Create the devXGrid  =============   ============= \xFE";
    z += "        Html = @jsb_html.devXGrid(\"<%=niceViewName%>\", DataSource, Settings)\xFE";
    z += "        \xFE";
    z += "        postScripts[-1] = \"\"\xFE";
    z += "        postScripts[-1] = \"function onFormSubmitEvent_devXGrid(event) {\"\xFE";
    z += "        postScripts[-1] = \"   var devXGridLayout = localStorage.<%=niceViewName%>;\"\xFE";
    z += "        postScripts[-1] = \"   if (devXGridLayout) {\"\xFE";
    z += "        postScripts[-1] = \"      // .columns (array), .allowedPageSizes (array, .filterPanel (json) .filterValue (string), .searchText (string), \"\xFE";
    z += "        postScripts[-1] = \"      // .pageIndex (integer), .pageSize (integer), .selectedRowKeys (array)\"\xFE";
    z += "        postScripts[-1] = \"      $('#jsb').append(\\\"<input id='devXGrid_devXGridLayout' name='devXGrid_devXGridLayout' type='hidden' />\\\");\"\xFE";
    z += "        postScripts[-1] = \"      $('#devXGrid_devXGridLayout').val(devXGridLayout);\"\xFE";
    z += "        postScripts[-1] = \"   }\"\xFE";
    z += "        postScripts[-1] = \"}\"\xFE";
    z += "        postScripts[-1] = \"\"\xFE";
    z += "        postScripts[-1] = \"$('#jsb').submit(onFormSubmitEvent_devXGrid);\"\xFE";
    z += "        postScripts[-1] = \"\"\xFE";
    z += "\xFE";
    z += "        preScripts[-1] = \"function devXGrid_onInit(s, e) { \"\xFE";
    z += "        preScripts[-1] = \"   $('.BtnReset').prop('disabled', false) \"\xFE";
    z += "        preScripts[-1] = \"}\"\xFE";
    z += "        \xFE";
    z += "        \xFE";
    z += "        preScripts[-1] = \"function devXGrid_LayoutChanged(s, e) { \"\xFE";
    z += "        preScripts[-1] = \"   $('.BtnReset').prop('disabled', false) \"\xFE";
    z += "        preScripts[-1] = \"}\"\xFE";
    z += "        \xFE";
    z += "    <%elseIf useJQGrid Then%>  \xFE";
    z += "        <%if viewModel.useajax Then%>\xFE";
    z += "            Dim urlSource As String, UrlParams As String\xFE";
    z += "            <%= @jsb_mdl.UrlPassThrough(viewModel) ; // This will setup UrlParams %>\xFE";
    z += "            urlSource = \"gridFetch_<%=niceViewName%>\":UrlParams\xFE";
    ...
    z += "       Dim rtnErrors As String = \"\"\xFE";
    z += "       Dim dataSet As Object = gridFetch_<%=niceViewName%>(FormVars, rtnErrors)\xFE";
